...
void RGBtoHSV(const uchar rgbImg[], int w, int h, uchar H_buff[], uchar S_buff[], uchar V_buff[]);

void HSVtoRGB(const uchar H_buff[], const uchar S_buff[], const uchar V_buff[], int w, int h, uchar rgbImg[]);
